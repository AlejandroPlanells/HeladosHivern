...
import com.mycompany.myapp.service.FabricanteQueryService;
import com.mycompany.myapp.service.FabricanteService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Fabricante}.
 */
@RestController
@RequestMapping("/api")
public class FabricanteResource {
    ...
    public ResponseEntity<FabricanteDTO> updateFabricante(
        ...
        FabricanteDTO result = fabricanteService.update(fabricanteDTO);
        return ResponseEntity
            .ok()
