...
describe('Ingrediente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ingrediente', component: IngredienteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ingredientes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ingredienteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIngredienteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIngredienteIdentifier).toHaveBeenCalledWith(entity);
