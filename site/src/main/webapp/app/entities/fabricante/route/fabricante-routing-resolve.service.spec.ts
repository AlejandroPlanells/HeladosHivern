...
describe('Fabricante routing resolve service', () => {
  ...
  let resultFabricante: IFabricante | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFabricante).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFabricante>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
